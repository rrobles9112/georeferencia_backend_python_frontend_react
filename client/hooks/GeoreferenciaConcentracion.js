...
import {simpleAction, increaseCount, actionFetchConcentration} from "./../reducersAndActions.js";
import {Button, Row, Col, Form, Select, Input, Spin, Tabs} from 'antd';
import MapsWithHeatmap from "./MapsWithHeatmap";
import {fetchMunicipios, fetchDpto, fetchVisita, fetchPromotoresByDpto} from '../helpers/functions';
...
const App = () => {
    ...
    const createGPX = () => {
        ...
        (async () => {
            ...
            dispatch(actionFetchConcentration({mun: mun, dp: dp, promotor:promotor, filter: queryString}));
        })();
        ...
        <div className="App">
             ...
             <Row justify="center" style={{width: '70%', margin: '0 auto'}}>
                    ...
                    <div className='map-container'>
                        <MapsWithHeatmap filter={queryString} center={markersData.filter(item => item.dpto == dp)[0]}/>
                    </div>
