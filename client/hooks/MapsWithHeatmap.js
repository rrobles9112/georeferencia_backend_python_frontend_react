...
import {useGoogleMap, useMapWithHeatMap} from "./maps_hooks";
...
const MapsWithHeatmap = (props) => {
    ...
    useMapWithHeatMap({googleMap, mapContainerRef, initialConfig, visitas, riesgosPorDepartamento});
    return (
        <>
            <div
                style={{
...
export default MapsWithHeatmap;
